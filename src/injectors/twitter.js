class TwitterInjector extends Injector {
    ...
    extractBio (container) {
        const bioElement = container.parentElement.parentElement.querySelector("[data-testid]");
    ...
    extractWriteTweet (container) {
        const writeTweetElement = container.parentElement.parentElement.parentElement.parentElement.parentElement;
    ...
    initialInjection () {
        setInterval(() => {
            /* Inject in Profile */
            const profileElement = Utils.findByClasses("css-1dbjc4n r-13awgt0 r-18u37iz r-1w6e6rj");
            if (profileElement) {
            ...
            const writeTweetElement = Utils.findByClasses("css-1dbjc4n r-1awozwy r-18u37iz r-1s2bzr4");
